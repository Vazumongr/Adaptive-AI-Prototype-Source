...
UCLASS()
class STRONGERTOGETHER_API USTAttributeSet : public UAttributeSet
{
	GENERATED_BODY()
public:
	...
	USTAttributeSet();
	//virtual void PreAttributeChange(const FGameplayAttribute& Attribute, float& NewValue) override; // Dont need
	...
	ATTRIBUTE_ACCESSORS(USTAttributeSet, AttackPower)
