...
#include "STAbilityTypes.generated.h"
...
struct FSTGameplayEffectContainer
{
	GENERATED_BODY()

public:
	FSTGameplayEffectContainer() {}

	/** Sets the way that targeting happens */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = GameplayEffectContainer)
	TSubclassOf<USTTargetType> TargetType;
...
USTRUCT(BlueprintType)
struct FSTGameplayEffectContainerSpec
{
	GENERATED_BODY()

public:
	FSTGameplayEffectContainerSpec() {}
